...
class _ProductoDetalleSheetState extends State<ProductoDetalleSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    // 1. Envolvemos el Container en un ClipRRect para redondear las esquinas de la ventana
    return ClipRRect(
      borderRadius: BorderRadius.circular(12),
      child: Container(
        decoration: const BoxDecoration(color: AppColors.background),
        // 2. Si estamos en PC/Web (bottom es 0), le damos un margen de 24 para que no quede pegado abajo
        padding: EdgeInsets.fromLTRB(0, 0, 0, bottom == 0 ? 24 : bottom),
        child: SingleChildScrollView(
          child: Column(
            mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              // 3. ¡ELIMINADO el Handle bar (la rayita gris) porque en modo ventana no tiene sentido!
