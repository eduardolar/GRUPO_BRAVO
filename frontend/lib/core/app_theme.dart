...
abstract final class AppTheme {
  ...
  static TextTheme get _textTheme {
    ...
    return TextTheme(
      ...
      displayLarge:  playfair(fontSize: 38, fontWeight: FontWeight.w700, height: 1.1),
      displayMedium: playfair(fontSize: 30, fontWeight: FontWeight.w700, height: 1.15),
      displaySmall:  playfair(fontSize: 24, fontWeight: FontWeight.w700, height: 1.2),

      // Headline — títulos de pantalla, secciones
      headlineLarge:  playfair(fontSize: 22, fontWeight: FontWeight.w700, letterSpacing: 1.5),
      headlineMedium: playfair(fontSize: 18, fontWeight: FontWeight.w700, letterSpacing: 1.0),
      ...
      labelLarge:  manrope(fontSize: 13, fontWeight: FontWeight.w700, letterSpacing: 1.5),
      labelMedium: manrope(fontSize: 11, fontWeight: FontWeight.w600, letterSpacing: 1.0),
      labelSmall:  manrope(fontSize: 10, fontWeight: FontWeight.w700, letterSpacing: 1.0),
    );
  }
